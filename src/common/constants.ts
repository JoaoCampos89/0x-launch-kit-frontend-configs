...
export const RELAYER_URL = process.env.REACT_APP_RELAYER_URL || 'https://relay.0xchange.org/v2/';
...
export const UI_DECIMALS_DISPLAYED_ON_STEP_MODALS = 5;
export const UI_DECIMALS_DISPLAYED_SPREAD_PERCENT = 2;
export const UI_DECIMALS_DISPLAYED_ORDER_SIZE = 5;
export const UI_DECIMALS_DISPLAYED_PRICE_ETH = 5;
